...
namespace Infrastructure.Data.Configuration
{
    public class ClienteDireccionConfiguration:IEntityTypeConfiguration<ClienteDireccion>
    {
        public void Configure(EntityTypeBuilder<ClienteDireccion> builder)
        {
            ...
            builder.Property(p => p.NumeroPri).HasColumnType("int");

            builder.Property(p => p.Letra).IsRequired().HasMaxLength(1);

            builder.Property(p => p.Bis).IsRequired().HasMaxLength(3);

            builder.Property(p => p.LetraSec).IsRequired().HasMaxLength(2);

            builder.Property(p => p.Cardinal).IsRequired().HasMaxLength(10);

            builder.Property(p => p.NumeroSec).HasColumnType("int");

            builder.Property(p => p.LetraTer).IsRequired().HasMaxLength(10);

            builder.Property(p => p.NumeroTer).HasColumnType("int");
